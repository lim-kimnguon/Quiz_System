...
public class QuestionLevelController {
  ...
  @GetMapping
  List<QuestionLevel> List(){
    return questionLevelService.ListAllQuestionLevel();
  }

  @GetMapping("/{id}")
  QuestionLevel ListById(@PathVariable Integer id){
    return questionLevelService.getQuestionLevel(id);
  }
